  ...
  <main class="studio">
    ...
    <section id="play-view" class="play-panel">
      ...
      <p class="hint keys-hint">ПРОБЕЛ / клик — подтвердить и пропустить паузы · ←/→ — рука ·
        ENTER — ввод имени/слова · буквы — набор текста · кнопка «Музыка» — вся музыка и эффекты (барабан, буквы, сектора, джинглы) · Ctrl+S — голос ведущего · TAB — выключить звук · ESC — новая игра</p>
    </section>
