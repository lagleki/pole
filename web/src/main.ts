  ...
  <main class="studio">
    ...
    <section id="play-view" class="play-panel">
      ...
      <p class="hint keys-hint">ПРОБЕЛ / клик — подтвердить и пропустить паузы · ←/→ — рука ·
        ENTER — ввод имени/слова · буквы — набор текста · кнопка «Музыка» — вся музыка (барабан, темы, джинглы) · Ctrl+S — голос и короткие эффекты · TAB — выключить звук · ESC — новая игра</p>
    </section>
